	  ...
	  <div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  ...
		  <ul class="nav navbar-nav">
			...
			<li><a href="#" class="glyphicon glyphicon-grain">&nbsp;师资团队</a></li>
			<li><a href="#" class="glyphicon glyphicon-sunglasses">&nbsp;明星学员</a></li>
			<li><a href="#" class="glyphicon glyphicon-plane">&nbsp;金科教育</a></li>
			<li class="dropdown">
			  <a href="#" class="dropdown-toggle glyphicon glyphicon-text-color" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">&nbsp;菜系 <span class="caret"></span></a>
	...
	<div class="row">
	  	...
	  	<div class="col-md-9">
				...
				<div class="tab-content">
				    <div role="tabpanel" style="" class="tab-pane active " id="home"><img alt="" src="css/866134.jpg" width="1000px" height="475px"></div>
				</div> 
	</div>
	</div>
...
<script type="text/javascript">
	$(function (){
		...
		$.ajax({
			url:"<%=request.getContextPath()%>/member/findTree.do",
			type:"post",
			dataType:"json",
